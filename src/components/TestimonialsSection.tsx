...
const testimonials = [
  {
    quote:
      "Working with Azure Petals was a pleasure. Their web design team created a stunning website that perfectly captured our brand's essence. The feedback from our customers has been overwhelmingly positive.",
    author: 'Mark Roberts',
  ...
  {
    quote:
      'The mobile app Azure Petals developed for us exceeded our expectations. Its user-friendly interface and seamless functionality have earned us rave reviews from our users. Highly recommended!',
  ...
  {
    quote:
      'Azure Petals transformed our outdated website into a modern, responsive platform. Their attention to detail and ability to understand our needs made the entire process smooth and hassle-free.',
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-4">
            Our <span className="text-[var(--text-accent)]">Testimonials</span>
          </h2>
          <p className="text-[var(--text-secondary)] max-w-2xl mx-auto">
            Don't just take our word for it. Hear what our satisfied clients
            have to say about their experience with Azure Petals. We take pride in
