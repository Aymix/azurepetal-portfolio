...
const services = [
  ...
  },
  {
    ...
    title: 'Web Design',
    description:
      "Elevate your brand aesthetics. Your website's design is a reflection of your brand's identity and values. Azure Petals's web design services focus on creating visually striking and user-friendly interfaces."
  },
  {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-4">
            Our <span className="text-[var(--text-accent)]">Services</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {services.map((service, index) =>
            <div
              ...
              <div className="w-16 h-16 bg-[var(--bg-tertiary)] rounded-2xl flex items-center justify-center mb-8 text-[var(--text-accent)] shadow-sm">
                {service.icon}
              </div>
